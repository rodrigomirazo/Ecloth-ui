...
export class UserItem {
    ...
    private _backSuspension: string;
    ...
    /**
     * Getter backSuspension
     * @return {string}
     */
	public get backSuspension(): string {
		return this._backSuspension;
	}
    ...
    /**
     * Setter backSuspension
     * @param {string} value
     */
	public set backSuspension(value: string) {
		this._backSuspension = value;
	}
